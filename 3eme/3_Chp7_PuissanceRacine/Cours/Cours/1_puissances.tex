...
\prop{Produit de puissance}
{Pour des nombres réels $a,b,n$ et $m$.
\begin{multicols}{2}
    \noindent$$a^n\times a^m=a^{n+m}$$
%
...
{\begin{align*}
    a^{-1}&=1\div a=\dfrac{1}{a}\\
    a^{-n}&=1\div a^n=\dfrac{1}{a^n}
\end{align*}}

\exmpl{
    \begin{align*}
        \left(\dfrac{2}{5}\right)^{-1} &= 1\div\dfrac{2}{5} & \left(\dfrac{-3}{4}\right)^{-2} &= 1\div\left(\dfrac{-3}{4}\right)^{2}\\
...
\prop{Quotient de puissance}
{Pour des nombres réels $a,b,n$ et $m$, avec $a$ et $b$ non nuls.
\begin{multicols}{2}
    \noindent$$\dfrac{a^n}{a^m}=a^{n-m}$$
%
