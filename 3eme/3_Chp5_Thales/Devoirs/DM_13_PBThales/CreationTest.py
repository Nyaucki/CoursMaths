...
def Creation(classe,seed_numb):
    ...
    with open(classe +"_DM_13_SujetEntier.tex","w") as fichier :
        fichier.write("\\documentclass{/home/nyaucki/Documents/Prof/CoursMaths/mycls/DevoirMaison}\n\\usepackage{tabularx}\n\\usepackage{pythontex}\n\\renewcommand{\\arraystretch}{1.5}\n\\begin{document}\n\\input{/home/nyaucki/Documents/Prof/CoursMaths/3eme/3_Chp5_Thales/Devoirs/DM_13_PBThales/Switch.tex}\n\\renewcommand{\\classe}{"+classe+"}\n")
        for i in range(len(noms)):
            ...
            ##### Question a #####
            ac=randint(10,19)
            Qu_A=[ac*13,ac*12,ac*4,randint(2,10)*ac]
