...
\fancyfoot[LO,R]{\the\year /\nextyear}
\fancyfoot[RO,L]{Attention, le sujet est recto-verso}
...
\newcounter{exrcntr}%counter d'exo
    \newcommand*{\exo}[2]{\bigskip \stepcounter{exrcntr}{\textbf{Exercice~\arabic{exrcntr}~:~}(/ #1 points) \textit{#2}}\setcounter{excntr}{0}\setcounter{excntrb}{0}}
