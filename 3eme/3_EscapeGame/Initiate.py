...
fa_list=["Baby","Ambulance","Anchor","PiedPiper","Bed","Bell","Bicycle","Bug","Camera","Cube","Plug","Envelope","Gavel","Globe","PuzzlePiece","Key","Lock","Magnet","Map","PaperPlane","Paw","BookReader","Utensils","Heart"]
