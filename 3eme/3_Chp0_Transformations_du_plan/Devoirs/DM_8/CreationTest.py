...
def Creation(classe,seed_numb):
    ...
    with open(classe +"_DM8_SujetEntier.tex","w") as fichier :
        fichier.write("\\documentclass{/home/nyaucki/Documents/Prof/CoursMaths/mycls/DevoirMaison}\n\\usepackage{tabularx}\n\\usepackage{pythontex}\n\\renewcommand{\\arraystretch}{1.5}\n\\begin{document}\n\\input{/home/nyaucki/Documents/Prof/CoursMaths/3eme/3_Chp0_Transformations_du_plan/Devoirs/DM_8/Switch.tex}\n\\renewcommand{\classe}{"+classe+"}\n")
