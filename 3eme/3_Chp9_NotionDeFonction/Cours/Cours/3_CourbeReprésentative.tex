...
\exmpl{
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[xscale=4]
            ...
            \draw[domain=-2:2]  plot (\x,{0.4*\x*\x*\x+0.8*\x*\x-\x-3}) node [left] {$f(x)$};
            \foreach \y in {2,...,1}
            {
...
\begin{minipage}{0.48\textwidth}
    ...
    \begin{itemize}
        ...
        \item \textcolor{blue}{On trace la droite depuis ce point jusqu'à l'axe des ordonnés.}
...
\begin{minipage}{0.48\textwidth}
    ...
    \begin{itemize}
        ...
        \item \textcolor{blue}{On trace la droite depuis ces points jusqu'à l'axe des abscisses.}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[xscale=2]
            ...
            \node[name intersections={of=curb and hotline},draw,red,cross] (X1) at (intersection-1) {};
            \node[name intersections={of=hotline and curb},draw,red,cross] (X2) at (intersection-2) {};
            \draw[dashed,blue] ($(ord-)!(X)!(ord+)$) -- (X);
            \node [magenta,above right] at ($(ord-)!(X)!(ord+)$) {-2,8};
        \end{tikzpicture}
    \end{figure}
