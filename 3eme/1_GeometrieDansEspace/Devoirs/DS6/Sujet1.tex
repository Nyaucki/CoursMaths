...
\begin{minipage}[t]{0.45\textwidth}
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[scale=1.5]
            ...
            \draw [fill=white] (0,0,0) --node [midway,above] {5} (2,0,0)-- node [midway,below left] {2}(2,1,0)--node [midway,above left] {3} (3,1,0)-- (3,0,0)--node [midway,above] {4} (5,0,0)--node [midway,left] {8}(5,4,0)--(3,4,0)-- (3,3,0)--(2,3,0) --node [midway,left] {1}(2,4,0)-- (0,4,0)--cycle; %Face avant
            \draw[dashed] (3,0,-2) --(5,0,-2);
            \draw[dashed] (3,0,0)--(3,0,-2)--(3,4,-2);
            \draw[dashed] (0,0,-2) --(2,0,-2);
            \draw[dashed] (0,0,0)--(0,0,-2)--(0,4,-2);
            \draw[dashed] (2,0.3,-2)--(2,3,-2);
