...
\begin{minipage}[t]{0.45\textwidth}
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \node (I1) at (0,1.5) {};
            \node (I2) at (1.5,3) {};
            \draw pic["$46$",draw=blue,fill=blue!20,angle eccentricity=1.3, angle radius=0.8cm]{angle=C2--I2--B2};
...
\begin{minipage}[t]{0.45\textwidth}
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \node (I1) at (1,1) {};
            \node (I2) at (3.5,1) {};
            \draw pic["$160$",draw=blue,fill=blue!20,angle eccentricity=1.5, angle radius=0.8cm]{angle=B1--I2--C2};
...
\begin{minipage}[t]{0.45\textwidth}
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[scale=1.25]
            ...
            \draw pic["$110$",draw=blue,fill=blue!20,angle eccentricity=1.3, angle radius=0.8cm]{angle=C1--I2--B2};
...
\begin{minipage}[t]{0.45\textwidth}
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[scale=1.25]
            ...
            \node (I3) at (1,2.5) {};
            \draw [gray,right angle quadrant=4,right angle symbol={A1}{A2}{D2}];
            \draw pic["$46$",draw=blue,fill=blue!20,angle eccentricity=1.3, angle radius=0.8cm]{angle=D1--I3--I1};
            \draw pic["44",draw=orange,fill=orange!20,angle eccentricity=1.4, angle radius=0.8cm]{angle=C2--I2--B2};
        \end{tikzpicture}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=1.25]
        ...
        \node (I) at (9.1,1.67) {};
        \draw pic["$50$",draw=blue,fill=blue!20,angle eccentricity=1.3, angle radius=0.8cm]{angle=E--A--D};
        \draw pic["30",draw=orange,fill=orange!20,angle eccentricity=1.4, angle radius=0.8cm]{angle=F--D--E};
