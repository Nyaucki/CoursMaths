...
% \exmpl{On va ici ordonner dans l'ordre croissant les nombres 13,1 ; 1,7 et 13,07.\\    
...
% \end{minipage}
% \begin{minipage}{0.7\textwidth}    
%     Le nombre le plus grand sera celui avec le chiffre de gauche le plus petit. Ici c'est le 0 de 01,70.  C'est donc 1,7 .
% \end{minipage}
% \hfill
% \begin{minipage}{0.22\textwidth}
%     \begin{figure}[H]
