...
\newcounter{exrcntr}%counter d'exo
    \newcommand*{\exo}[2]{\bigskip \refstepcounter{exrcntr}{\textbf{Exercice~\arabic{exrcntr}~:~} \textit{#1}}\setcounter{excntr}{0}\setcounter{excntrb}{0}\label{#2}}%Rajouter un if pas correction
