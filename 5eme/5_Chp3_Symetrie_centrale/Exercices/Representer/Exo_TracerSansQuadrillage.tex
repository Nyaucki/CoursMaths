...
\begin{minipage}[t]{0.45\textwidth}
    \exo{Représenter}{TracerSymCentBlanc5}
...
\hfill
\begin{minipage}[t]{0.45\textwidth}
    \exo{Représenter}{TracerSymCentBlanc6}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \draw [white](-3,-3) grid (4,4);
            \draw [thick]\mypath ;
            \fill (-0.5,1) coordinate (c) circle(2pt) node [above] {$O$};
            % \begin{scope}[homothety at=c scaled by -1]
            %     \draw[dashed] \mypath;
            % \end{scope}
        \end{tikzpicture}
...
\begin{minipage}[t]{0.45\textwidth}
    \exo{Représenter}{TracerSymCentBlanc7}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \tikzset{
                homothety at/.style args={#1 scaled by #2}{shift={($(#1)!#2!(0,0)$)},scale=#2},}
            \def\mypath{(-2,-2) -- (0,-1) --(3,-2) -- (2,-2)--(-1,-1)--(-2,-2)}
            \draw [white](-3,-3) grid (4,4);
            \draw [thick]\mypath ;
            \fill (-1,-1) coordinate (c) circle(2pt) node [above] {$O$};
            % \begin{scope}[homothety at=c scaled by -1]
...
\hfill
\begin{minipage}[t]{0.45\textwidth}
    \exo{Représenter}{TracerSymCentBlanc8}
