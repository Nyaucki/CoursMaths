...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=\den]
        ...
        \foreach \z [count=\zi] in {#4 * \pas , #5 * \pas , #6 * \pas , #7 * \pas}
        {
          % \node at (\z,\grad) [above] {\makeAlph{\zi}};
          \draw[-Stealth] (\z,5*\grad)--(\z,1.5*\grad);
        }
...
\fracdgmult{5}{0}{3}{7}{1}{12}

\fracdgmult[2]{12}{0}{-1}{7}{1}{12}
