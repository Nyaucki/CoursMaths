...
if __name__=="__main__":
    ...
    labyrinthe(path=path,name=name,consigne="Traverser le labyrinthe en franchissant les cases dans l'ordre décroissant ",valDepart=valDepart,funcplus=funcplus,funcmoins=funcmoins,finish=finish,scale=1.7)
