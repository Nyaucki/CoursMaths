...
\begin{minipage}{0.45\textwidth}
    \begin{figure}[H]
        \center
        \begin{tikzpicture}
            \draw (0,0) coordinate (A) --node [midway,below] {\eTqAmA} (5,0) coordinate (B) --node [midway,above right] {\eTqAmB} (2,3) coordinate (C) --node [midway,above left] {\eTqAmC} cycle;
            \draw[dashed] ($(A)!(C)!(B)$)--node [midway,right]{\eTqAmD} (C); %Perpendiculaire
...
\begin{minipage}{0.45\textwidth}
    \begin{figure}[H]
        \center
        \begin{tikzpicture}
            \draw (-0.5,-0.5) coordinate (A) --node [midway,below] {\eTqBmA} (5,-1) coordinate (B) --node [midway,below left] {\eTqBmB} (2,1.2) coordinate (C) --node [midway,below right] {\eTqBmC} cycle;
            \draw[dashed] ($(A)!(B)!(C)$)--node [midway,right]{\eTqBmD} (B);%Perpendiculaire
...
\begin{minipage}[t]{0.45\textwidth}
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \draw pic["\eQqAmA °",draw=green,fill=green!20,angle eccentricity=1.4, angle radius=0.7cm]{angle=B--A--C};
            \draw pic["\eQqAmB °",draw=green,fill=green!20,angle eccentricity=1.3, angle radius=0.8cm]{angle=C--D--B};
            \draw pic["\eQqAmC °",draw=green,fill=green!20,angle eccentricity=1.3, angle radius=0.7cm]{angle=A--C--B};
...
\begin{minipage}[t]{0.45\textwidth}
    \begin{figure}[H]
        \center
        \begin{tikzpicture}
            \draw (0.5,0) coordinate (A) -- node[sloped, rotate=20] {$\parallel$} (3,0) coordinate (B) -- (7,0) coordinate (C) --(4.5,-2) coordinate (D) --node[sloped, rotate=20] {$\parallel$} (1.5,-2) coordinate (E)--cycle;
            \draw (E)--node[sloped, rotate=20] {$\parallel$}(B)--node[sloped, rotate=20] {$\parallel$}(D);
            \draw pic["\eQqBmA °",draw=green,fill=green!20,angle eccentricity=1.4, angle radius=0.7cm]{angle=B--E--A};
            \draw pic["\eQqBmB °",draw=green,fill=green!20,angle eccentricity=1.3, angle radius=0.8cm]{angle=C--D--B};
...
\begin{minipage}[t]{0.45\textwidth}
    \begin{figure}[H]
        \center
        \begin{tikzpicture}
            \draw (0,0) coordinate (A) node[below left]{A}--node [midway,below] {\eCqAmA} (5,0) coordinate (B) node [below right]{B} --(0,3) coordinate (C) node[above]{C} --node [midway,above left] {\eCqAmB} cycle;
            \draw[dashed] ($(C)!(A)!(B)$) node[above right]{H}--node [midway,right]{4} (A); 
            %Perpendiculaire
