...
consigne="Simplifie les calculs suivants" #La consigne générale

path="Ex_Calculer/Exo_SimplifieCalcul.tex" # Le chemin (relatif suffit) vers le fichier à modifier/ecrire
...
for index in exo:
    ...
    exo[index]=str(randint(2,10))+lettre+plusmoins()+str(randint(2,10))+plusmoins()+str(randint(2,10))+lettre+plusmoins()+str(randint(2,10))
