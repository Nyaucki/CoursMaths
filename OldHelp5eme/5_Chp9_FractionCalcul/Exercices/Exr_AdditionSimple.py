...
ref="AddSimple" # Ce qui servira de référence aux exercices pour le fichier Tex
...
path="Ex_Calculer/Exo_AdditionsSimples.tex" # Le chemin (relatif suffit) vers le fichier à modifier/ecrire
